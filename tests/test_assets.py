...
class TestAssetsMethods(unittest.TestCase):
        ...
        self._sample_assets_resp = [
            {
                ...
                "lease_price": 120,
                "convert_from": [{"ticker": "string", "quantity": 0}],
                "convert_to": [{"ticker": "string", "quantity": 0}],
                "containment": {"ticker": "string", "quantity": 0},
    ...
    def test_assets_dict(self):
        ...
        class_dict = {
            self._sample_assets_resp[0]["ticker"]: assets.Asset(
