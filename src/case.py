...
def get_limits_case_all( ses ):
    if trade_lim_enforce_chk() == True:
        resp_json = get_case_response( ses, '/limits', '', 1)
    else:
        no_lim_msg = "No trading limits for the current case"
        return no_lim_msg
